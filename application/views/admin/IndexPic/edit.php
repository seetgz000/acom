            ...
            <div class="col-lg-8 col-md-8 col-xs-12 col-sm-12">
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        ...
                        <form id="indexPic_form" method="POST" action="<?php echo site_url("IndexPic/edit/" . $indexPic['index_pic_id']); ?>" enctype="multipart/form-data">
                            <div class="row">
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status) {
                    ...
                    setTimeout(function () {
                        window.location = "<?= site_url('IndexPic'); ?>";
                    }, 1500);
                } else {
