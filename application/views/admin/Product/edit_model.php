                    ...
                    <div class="box-body">
                        ...
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs" id="tabs">
                                <li class="active">
                                    <a href="#models" data-toggle="tab">Model</a>
                                </li>
                            </ul>
                        </div>
                        <form id="product_form" method="POST" action="<?php echo site_url("Product/edit_model/" . $model['model_id']); ?>" enctype="multipart/form-data">
                            <div class="tab-content">
                                <div class="tab-pane active" id="models">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                            <label>Model</label>
                                            <input type="text" class="form-control" required name="model" placeholder="Model" id="form_model" value="<?= $model['model'] ?>">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                            <label>SKU</label>
                                            <input type="text" class="form-control" required name="sku" placeholder="SKU" id="form_sku" value="<?= $model['SKU'] ?>">
                                        </div>
                                    </div>
                                    <br/>
